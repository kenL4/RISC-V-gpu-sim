...
private:
    ...
    bool beqz(Warp *warp, std::vector<size_t> active_threads, cs_riscv *riscv);
    bool bne(Warp *warp, std::vector<size_t> active_threads, cs_riscv *riscv);
    bool bnez(Warp *warp, std::vector<size_t> active_threads, cs_riscv *riscv);
    ...
    bool bltz(Warp *warp, std::vector<size_t> active_threads, cs_riscv *riscv);
    bool bgt(Warp *warp, std::vector<size_t> active_threads, cs_riscv *riscv);
    bool bgtu(Warp *warp, std::vector<size_t> active_threads, cs_riscv *riscv);
    bool bgtz(Warp *warp, std::vector<size_t> active_threads, cs_riscv *riscv);
    bool ble(Warp *warp, std::vector<size_t> active_threads, cs_riscv *riscv);
    bool bleu(Warp *warp, std::vector<size_t> active_threads, cs_riscv *riscv);
    bool blez(Warp *warp, std::vector<size_t> active_threads, cs_riscv *riscv);
    ...
    bool bgez(Warp *warp, std::vector<size_t> active_threads, cs_riscv *riscv);
